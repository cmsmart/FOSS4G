...
<div class="nav-outer container-fluid fixed">
  <div id="navbar" class="container navbar navbar-default">
    ...
    <a class="navbar-brand" href="/"><img id="globe" height="45" width="auto" src="/sites/all/themes/foss4g/globe.png"></a>
...
<div class="main-container container">
  ...
  <div class="row">
    ...
    <section>
      <?php if (!empty($page['front_blocks'])): ?>
            <?php print render($page['front_blocks']); ?>
      <?php endif; ?>
    </section>

    <section>
      <?php if (!empty($page['front_sponsors'])): ?>
            <?php print render($page['front_sponsors']); ?>
      <?php endif; ?>
    </section>
